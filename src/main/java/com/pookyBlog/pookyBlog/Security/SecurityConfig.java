package com.pookyBlog.pookyBlog.Security;

import com.pookyBlog.pookyBlog.Repository.UserRepository;
import com.pookyBlog.pookyBlog.Security.auth.CustomUserDetailsService;
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth-> auth
                        ...
                        .requestMatchers("/posts/{postId}","/posts","/posts/getPost/**").permitAll()
